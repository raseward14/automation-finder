...
// change start date
// change due date
export function ChangeDateCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function ChangeTagsCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function ChangeTaskTypeCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function ChangeWatchersCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function CreateAListCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function CreateATaskCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function CreateASubtaskCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function DuplicateCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function TimeCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
// add to list
// move to list
export function ToListCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function SetCustomFieldCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function CommentCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
...
export function AssigneeCard({ cardDetails, key}) {
  return (
    <>
      <Card className="action-card" key={key}>
        <Card.Body>
